...
wget -q -O /etc/status "https://raw.githubusercontent.com/RMBLsukarata/vip/main/status"
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/RMBLsukarata/vip/main/menu/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
...
serverV=$( curl -sS https://raw.githubusercontent.com/RMBLsukarata/vip/main/versi)
if [ "$Isadmin" = "ON" ]; then
...
echo -e "$COLOR1║ $NC${WH}➡️ System OS          ${COLOR1}: ${WH}$MODEL2"
echo -e "$COLOR1║ $NC${WH}➡️ Memory Usage       ${COLOR1}: ${WH}$uram - $tram"
if [ "$cekup" = "day" ]; then
echo -e "$COLOR1║ $NC${WH}➡️ System Uptime      ${COLOR1}: ${WH}$uphours $upminutes $uptimecek"
else
echo -e "$COLOR1║ $NC${WH}➡️ System Uptime      ${COLOR1}: ${WH}$uphours $upminutes"
fi
#echo -e "$COLOR1 $NC ${WH}LOAD CPU           ${COLOR1}: ${WH}$LOADCPU"
echo -e "$COLOR1║ $NC${WH}➡️ Core & CPU Usage   ${COLOR1}: ${WH}$CORE & $cpu_usage"
echo -e "$COLOR1║ $NC${WH}➡️ ISP & City         ${COLOR1}: ${WH}$ISP & $CITY"
echo -e "$COLOR1║ $NC${WH}➡️ Domain             ${COLOR1}: ${WH}$(cat /etc/xray/domain)"
echo -e "$COLOR1║ $NC${WH}➡️ IP-VPS             ${COLOR1}: ${WH}$IPVPS${NC}"
echo -e "$COLOR1║ $NC${WH}➡️ DATE & TIME        ${COLOR1}: ${WH}$DATE2 WIB${NC}"
echo -e "$COLOR1║ $NC${WH}➡️ NAMA AUTHOR        ${COLOR1}: ${WH}$author${NC}"
echo -e "$COLOR1╚═════════════════════════════════════════════════╝${NC}"
echo -e "$COLOR1╔═════════════════════════════════════════════════╗${NC}"
...
echo -e "$COLOR1║                                                 $COLOR1║ $NC"
echo -e "$COLOR1║ ${WH}[${COLOR1}05${WH}]${NC} ${COLOR1}• ${WH}RESTORE   ${WH}[${COLOR1}Menu${WH}]   ${WH}[${COLOR1}10${WH}]${NC} ${COLOR1}• ${WH}BACKUP    ${WH}[${COLOR1}Menu${WH}]$COLOR1║ $NC"
echo -e "$COLOR1╚═════════════════════════════════════════════════╝${NC}"
...
function bannner(){
wget -O /etc/issue.net "https://raw.githubusercontent.com/RMBLsukarata/vip/main/install/issue2.net" &> /dev/null
menu
}
echo -e "$COLOR1╔═════════════════════════════════════════════════╗${NC}"
